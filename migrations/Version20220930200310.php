 ...
 */
final class Version20220930200310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, companie_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, datedepublication DATE NOT NULL, datededebut DATE NOT NULL, datedefin DATE NOT NULL, tarif DOUBLE PRECISION NOT NULL, hello VARCHAR(255) NOT NULL, INDEX IDX_AF86866F9DC4CE1F (companie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
